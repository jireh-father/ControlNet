...
def main(args):
    ...
    trainer = pl.Trainer(accelerator="gpu", gpus=args.num_gpus, precision=args.precision, callbacks=[logger, checkpoint_callback],
...
if __name__ == '__main__':
    ...
    # strategy
    parser.add_argument('--strategy', type=str, default='horovod')#dp, ddp, ddp2, horovod, ddp_spawn, ddp_sharded
    # batch_size
